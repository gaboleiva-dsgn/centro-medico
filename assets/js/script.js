...
// Se muestra atravéz de document write el reslutado del ejercicio 1
document.write("<h2>Pacientes de consultas de traumatología (Menos el primero y el último) </h2>");
traumatologia.forEach(function(consultaTrauma) {
